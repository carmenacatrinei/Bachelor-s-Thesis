...
tran1 = Transition "t1" (S "s0") (S "s0") (Eq (Var (V "DrSt")) (Const 0) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos"] [Atrib (V "DrSt") (Const 1)]
tran2 = Transition "t2" (S "s0") (S "s0") (Eq (Var (V "DrSt")) (Const 1) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos", I "Pw"] [Atrib (V "DrSt") (Const 0)]
tran3 = Transition "t3" (S "s0") (S "s1") (Eq (Var (V "DrSt")) (Const 0) :&: Eq (Param "Pf") (Const 1) :&: Gte (Var (V "w")) (Const 15) :&: Lte (Var (V "w")) (Const 250) :&: Gte (Param "Ph") (Const 10) :&: Lte (Param "Ph") (Const 35) :&: Gte (Param "Ps") (Const 0) :&: Lte (Param "Ps") (Const 25)) [I "Pf", I "Ph", I "Ps"] [Atrib (V "Floor") (Const 1)]
tran4 = Transition "t4" (S "s1") (S "s0") (Eq (Var (V "DrSt")) (Const 0) :&: Eq (Param "Pf") (Const 0) :&: Gte (Var (V "w")) (Const 15) :&: Lte (Var (V "w")) (Const 250) :&: Gte (Param "Ph") (Const 10) :&: Lte (Param "Ph") (Const 35) :&: Gte (Param "Ps") (Const 0) :&: Lte (Param "Ps") (Const 25)) [I "Pf", I "Ph", I "Ps"] [Atrib (V "Floor") (Const 0)]
...
tran7 = Transition "t7" (S "s1") (S "s1") (Eq (Var (V "DrSt")) (Const 0) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos"] [Atrib (V "DrSt") (Const 1)]
tran8 = Transition "t8" (S "s1") (S "s1") (Eq (Var (V "DrSt")) (Const 1) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos", I "Pw"] [Atrib (V "DrSt") (Const 0), Atrib (V "w") (Param "Pw")]
...
tran13 = Transition "t13" (S "s2") (S "s2") (Eq (Var (V "DrSt")) (Const 0) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos"] [Atrib (V "DrSt") (Const 1)]
tran14 = Transition "t14" (S "s2") (S "s2") (Eq (Var (V "DrSt")) (Const 1) :&: Gte (Param "Pos") (Const 0) :&: Lte (Param "Pos") (Const 15)) [I "Pos", I "Pw"] [Atrib (V "DrSt") (Const 0), Atrib (V "w") (Param "Pw")]
...
efsm :: EFSM
efsm =
    EFSM {states = [S "s0", S "s1", S "s2", S "ss"], transitions = transition, vars = [V "DrSt", V "w", V "Floor"], start = S "s1"}
