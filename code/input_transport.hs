...
tran8 = Transition "t8" (S "s4") (S "s4") (Dif (Var (V "R_credit")) (Const 0) :&: Eq (Param "Send_sq") (Var (V "TRsq"))) [I "Send_sq"] [Atrib (V "TRsq") (((Var (V "TRsq")) :+: (Const 1)) :%: (Const 128)), Atrib (V "R_credit") ((Var (V "R_credit")) :-: (Const 1))]
